  ...
  const tChat = {
    es: {
      ...
      responses: {
        ...
        contacto: "¡Excelente decisión! Puedes agendar una sesión de diagnóstico directamente en nuestro Calendario de Google oficial: <a href=\"https://calendar.app.google/kPvoFWxzmhijrEKW9\" target=\"_blank\" rel=\"noreferrer noopener\" class=\"text-brand underline hover:text-brand-dark break-all\">calendar.app.google/kPvoFWxzmhijrEKW9</a>",
        default: "Gracias por tu mensaje. Para darte la mejor atención personalizada, te sugiero usar el botón 'Colaboremos' en el menú o visitar nuestro Calendario de Google: <a href=\"https://calendar.app.google/kPvoFWxzmhijrEKW9\" target=\"_blank\" rel=\"noreferrer noopener\" class=\"text-brand underline hover:text-brand-dark break-all\">calendar.app.google/kPvoFWxzmhijrEKW9</a>",
    ...
    en: {
      ...
      responses: {
        ...
        contacto: "Great! You can schedule a direct diagnostic session on our official Google Calendar: <a href=\"https://calendar.app.google/kPvoFWxzmhijrEKW9\" target=\"_blank\" rel=\"noreferrer noopener\" class=\"text-brand underline hover:text-brand-dark break-all\">calendar.app.google/kPvoFWxzmhijrEKW9</a>",
        default: "Thank you for your message. For personalized assistance, I suggest using the 'Work with me' button or visiting our Google Calendar: <a href=\"https://calendar.app.google/kPvoFWxzmhijrEKW9\" target=\"_blank\" rel=\"noreferrer noopener\" class=\"text-brand underline hover:text-brand-dark break-all\">calendar.app.google/kPvoFWxzmhijrEKW9</a>",
          ...
          <div className="flex-1 p-4 overflow-y-auto space-y-4 bg-[#f8f9fa] dark:bg-[#070a0e]/40 scrollbar-thin">
            {messages.map((msg) => (
              ...
              >
                ...
                >
                  <p className="whitespace-pre-line text-left" dangerouslySetInnerHTML={{ __html: msg.text }} />
                </div>
